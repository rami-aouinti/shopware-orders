...
class LieferzeitenImportServiceTest extends TestCase
{
    ...
    public function testResolveAndApplyBusinessDatesPrefersLatestShippingDateOverAliasAndExistingBusinessDateTo(): void
    {
        $settingsProvider = $this->createMock(ChannelDateSettingsProvider::class);
        $settingsProvider->method('getForChannel')->with('shopware')->willReturn([
            'shipping' => 1,
        ...
        $service = $this->createService(
            baseDateResolver: new BaseDateResolver(),
            settingsProvider: $settingsProvider,
            deliveryDateCalculator: new BusinessDayDeliveryDateCalculator(),
        );
        ...
        [$result] = $method->invoke($service, [
            ...
            'latestShippingDate' => '2026-02-07T15:00:00+00:00',
            'shippingDateLatest' => '2026-02-08T16:00:00+00:00',
            'businessDateTo' => '2026-02-09T17:00:00+00:00',
        ], 'shopware');

...
class NeuerLieferterminHistoryDefinition extends EntityDefinition
{
    public const ENTITY_NAME = 'lieferzeiten_neuer_liefertermin_history';
    ...
    {
        return NeuerLieferterminHistoryCollection::class;
    }

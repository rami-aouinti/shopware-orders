...
class DemoDataSeederService
{
    ...
    private function buildOrderDataset(\DateTimeImmutable $base, array $externalOrderIds): array
    {
        $scenarioTemplates = [
            ...
            [
                'scenarioKey' => 'tracking_zugestellt_closable',
                'domain' => self::DOMAINS[2],
                'status' => 8,
                'shippingType' => 'dhl',
                'orderDateModifier' => '-7 days',
                'taskStatus' => 'closed',
                'taskType' => 'tracking_completion_gate',
                'isTestOrder' => false,
                'paymentDateMode' => 'set',
                ...
                'positions' => [
                    [
                        ...
                        'orderedQuantity' => 1,
                        'shippedQuantity' => 1,
                        'splitReference' => 'TRACK-ZUGESTELLT',
                        'trackingHistory' => [
                            ['sendenummer' => 'DHL-{suffix}-ZUGESTELLT', 'carrier' => 'dhl', 'isActive' => true],
                        ],
                    ],
                ],
            ],
            [
                'scenarioKey' => 'tracking_paketshop_zugestellt_not_collected_non_closable',
                'domain' => self::DOMAINS[0],
                'status' => 7,
                'shippingType' => 'dhl',
                'orderDateModifier' => '-8 days',
                'taskStatus' => 'open',
                'taskType' => 'tracking_completion_gate_waiting_pickup',
                'isTestOrder' => false,
                'paymentDateMode' => 'set',
                'partialShipmentQuantity' => '1/1',
                'businessDays' => 10,
                'positions' => [
                    [
                        ...
                        'orderedQuantity' => 1,
                        'shippedQuantity' => 1,
                        'splitReference' => 'TRACK-PAKETSHOP',
                        'trackingHistory' => [
                            ['sendenummer' => 'DHL-{suffix}-PAKETSHOP-ZUGESTELLT', 'carrier' => 'dhl', 'isActive' => true],
                        ],
                    ],
                ],
            ],
            [
                'scenarioKey' => 'tracking_verweigert_retoure_zoll_abgelehnt_non_closable',
                'domain' => self::DOMAINS[1],
                'status' => 6,
                'shippingType' => 'dhl',
                'orderDateModifier' => '-9 days',
                'taskStatus' => 'open',
                'taskType' => 'tracking_completion_gate_blocked',
                'isTestOrder' => false,
                'paymentDateMode' => 'set',
                'partialShipmentQuantity' => '3/3',
                'terminalDelivery' => false,
                'businessDays' => 10,
                'positions' => [
                    [
                        ...
                        'orderedQuantity' => 1,
                        'shippedQuantity' => 1,
                        'splitReference' => 'TRACK-VERWEIGERT',
                        'trackingHistory' => [
                            ['sendenummer' => 'DHL-{suffix}-VERWEIGERT', 'carrier' => 'dhl', 'isActive' => true],
                        ],
                    ],
                    [
                        'status' => 'open',
                        'orderedQuantity' => 1,
                        'shippedQuantity' => 1,
                        'splitReference' => 'TRACK-RETOURE',
                        'trackingHistory' => [
                            ['sendenummer' => 'DHL-{suffix}-RETOURE', 'carrier' => 'dhl', 'isActive' => true],
                        ],
                    ],
                    [
                        'status' => 'open',

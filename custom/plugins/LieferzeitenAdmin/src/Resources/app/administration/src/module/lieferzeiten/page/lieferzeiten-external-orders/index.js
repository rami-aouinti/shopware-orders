...
import './lieferzeiten-external-orders.scss';
    ...
    methods: {
        ...
        statusClassFromLabel(statusLabel) {
            ...
            if ([
                ...
                return 'lieferzeiten-external-orders__status-pill--blue';
            }

            if (normalizedStatusLabel === 'vorkasse: bezahlung offen') {
                return 'lieferzeiten-external-orders__status-pill--yellow';
            }

            if (normalizedStatusLabel === 'versendet') {
                return 'lieferzeiten-external-orders__status-pill--green';
            }

            if (normalizedStatusLabel === 'bestellung abgeschlossen') {
                return 'lieferzeiten-external-orders__status-pill--black';
            }

            if (normalizedStatusLabel === 'stornierung abgeschlossen') {
                return 'lieferzeiten-external-orders__status-pill--gray';
            }
